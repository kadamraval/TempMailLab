...
import { BarChart, Briefcase, KeyRound, Mail, MessageSquare, Monitor, MousePointerClick, Zap, Tags, Database } from "lucide-react";
...
const integrations = [
    { 
        ...
        category: "Core", 
        title: "Firebase", 
        description: "Core service for authentication and database.", 
        icon: <Database className="h-6 w-6 text-yellow-500" />,
        configured: true, // Let's assume it's configured to show "Settings"
    },
     { 
        slug: "mail-tm",
        category: "Core", 
        title: "Mail.tm", 
        description: "API for generating temporary email addresses.", 
